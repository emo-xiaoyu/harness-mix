...
export interface DroppedSkillFile { path: string; contentBase64: string }
export interface SkillChange { name: string; root?: string; source?: string; files?: DroppedSkillFile[]; action: 'install' | 'enable' | 'disable' }
